...
const App = () => {
  ...
  const auth = ""
  ...
  const handleSubmit = async (e) => {
    ...
    if (!descripcion.trim()) {
      ...
      axios.post('https://gpenna.atlassian.net/rest/api/3/issue', bodyData, {
        headers: {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center bg-softlandbg ">
